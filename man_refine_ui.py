...
from  utils import pil_image_translate
...
class RefineManuallyGUI:
    def __init__(self, master, master_data, callback):
        ...
        self.translateX = master_data.translateX
        self.translateY = master_data.translateY
        self.zoom_scale = master_data.zoom_scale
